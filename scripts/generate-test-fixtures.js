...
const FIXTURES_DIR = path_1.default.join(process.cwd(), 'test-fixtures');
const IMAGES_DIR = path_1.default.join(FIXTURES_DIR, 'images');
const CODE_DIR = path_1.default.join(FIXTURES_DIR, 'code');
const OUTPUT_DIR = path_1.default.join(FIXTURES_DIR, 'output');
async function generateTestImages() {
    await promises_1.default.mkdir(IMAGES_DIR, { recursive: true });
    ...
    }).jpeg({ quality: 90 }).toFile(path_1.default.join(IMAGES_DIR, 'hero-image.jpg'));
    await (0, sharp_1.default)({
        create: {
            width: 400,
            height: 400,
    ...
    }).png().toFile(path_1.default.join(IMAGES_DIR, 'logo.png'));
    await (0, sharp_1.default)({
        create: {
            width: 1200,
            height: 630,
    ...
    }).jpeg({ quality: 85 }).toFile(path_1.default.join(IMAGES_DIR, 'og-image.jpg'));
    await (0, sharp_1.default)({
        create: {
            width: 64,
            height: 64,
    ...
    }).png().toFile(path_1.default.join(IMAGES_DIR, 'icon.png'));
    console.log('  ✓ Generated 4 test images');
}
async function generateTestCode() {
    await promises_1.default.mkdir(CODE_DIR, { recursive: true });
    console.log('Generating test code files...');
    // React component with image references
    await promises_1.default.writeFile(path_1.default.join(CODE_DIR, 'Hero.tsx'), `import Image from 'next/image';
...
`);
    ...
    await promises_1.default.writeFile(path_1.default.join(CODE_DIR, 'styles.css'), `.hero {
...
`);
    // HTML file
    await promises_1.default.writeFile(path_1.default.join(CODE_DIR, 'index.html'), `<!DOCTYPE html>
<html>
<head>
...
`);
    // Markdown file
    await promises_1.default.writeFile(path_1.default.join(CODE_DIR, 'README.md'), `# Test Documentation
...
async function generateReadme() {
    await promises_1.default.writeFile(path_1.default.join(FIXTURES_DIR, 'README.md'), `# Test Fixtures

This directory contains test data for manual testing of opsutil.
...
main();
//# sourceMappingURL=generate-test-fixtures.js.map